...
//    @Query(value = "SELECT * FROM board b join user u on b.user_id=u.user_id where b.is_deleted='N'",
//            countQuery = "SELECT count(*) FROM board b join user u on b.user_id=u.user_id where b.is_deleted='N'",
//            nativeQuery = true
//    )
